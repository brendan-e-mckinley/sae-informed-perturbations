...
plt.plot(range(80), cos_sim_sae, linestyle='--', marker='o', color='red')
plt.plot(range(80), cos_sim_random, linestyle='--', marker='o', color='green')
plt.plot(range(80), cos_sim_random_random, linestyle='--', marker='o', color='blue')
...
plt.plot(group_count, random_random_groups, linestyle='--', marker='o', color='red')
